...
namespace SDKSample
{
    namespace ListViewSimple
    {
        ...
        private:
            ...
            private: ::Windows::UI::Xaml::Controls::Button^ FileOpenButton;
            private: ::Windows::UI::Xaml::Controls::Button^ AssembleButton;
            private: ::Windows::UI::Xaml::Controls::Button^ DisplayOutputButton;
