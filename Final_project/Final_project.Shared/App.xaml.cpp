...
{	
    ...
    if (rootFrame == nullptr)
    {
		...
		SDKSample::Common::SuspensionManager::RegisterFrame(rootFrame, "appFrame");
		...
		if (e->PreviousExecutionState == ApplicationExecutionState::Terminated)
		{
			...
			prerequisite = SDKSample::Common::SuspensionManager::RestoreAsync();
		}
...
void App::OnSuspending(Object^ sender, SuspendingEventArgs^ e)
{
	...
	SDKSample::Common::SuspensionManager::SaveAsync().then([=]()
	{
		deferral->Complete();
	});
}